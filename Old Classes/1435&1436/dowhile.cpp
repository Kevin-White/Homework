...
int main()
{
    ...
    do
    {
        ...
        cin >> beverage;
        // Fill in the code to validate the menu selection (use while loop)
        while(beverage != 'e' && beverage != 'E' && number >= 0){
        ...
        case 'E': cout << " Please come again" << endl;
            break;
        default: cout << " The input you gave was invalid" << endl;    // Fill in the code to write a message
