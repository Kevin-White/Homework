...
int play_game_start()
{
	...
	do
	{
		...
		else if (todo.find("day") != string::npos || todo.find("date") != string::npos || todo.find("time") != string::npos)
		{

			cout << "You walk over to your phone and check the time, it is Thursday 9:" << timeT << ", your next class is at" << endl
	...
	while (!getout) {
		...
		if (todo.find("wallet") != string::npos && !wallet)
		{
			...
			cout << "You leave your room to the library... hoping you didnt miss anything again" << endl
				<< "It is currently 9:" << timeT << endl << endl;
			getout = true;
			cin.get(); 
...
void bad_end()
{
	...
	cout << "The time reads 10:" << timeT-60 << "." << endl << endl;
	cin.get();
...
void good_end()
{
	...
	cout << "The time reads 9:" << timeT << "." << endl << endl;
