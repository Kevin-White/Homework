...
private:
   ...
   void printList(ListNode *current) const;
   void printListReverse(ListNode *current) const;
   void printListSkip(ListNode *current) const;
   int recursiveNumNode(ListNode *current) const;
   bool sequentialSearch(ListNode *current, T look) const;
...
public:
   ...
   void printListSkip() const;
   int recursiveNumNode() const;
   bool sequentialSearch(T look) const;
};
...
template <class T>
void LinkedList<T>::printList(ListNode *current) const
{
   if (current != NULL)
   {
      cout << current->value << " "; 
...
template <class T>
void LinkedList<T>::printListSkip(ListNode *current) const
{
   if (current != NULL)
   {
      cout << current->value << " "; 
      printListSkip(current->next->next); 
      
   }
}

template <class T>
void LinkedList<T>::printListSkip() const
{
   printListSkip(head);
   cout << endl;
}
...
template <class T>
int LinkedList<T>::recursiveNumNode(ListNode *current) const
{
   if (current != NULL)
   { 
      return 1 + recursiveNumNode(current->next); 
   }
   return 0;
}

template <class T>
int LinkedList<T>::recursiveNumNode() const
{
   return recursiveNumNode(head);
}

template <class T>
bool LinkedList<T>::sequentialSearch(ListNode *current, T look) const
{
   if (current != NULL)
   { 
      if(current->value == look){
         ...
         return sequentialSearch(current->next, look);
      }
...
template <class T>
bool LinkedList<T>::sequentialSearch(T look) const
{
   return sequentialSearch(head, look);
}
#endif